                ...
                <section class="team-tab">
                    <div class="grid-container">
                        <div class="grid-x grid-margin-x">
                            ...
                            <?php
                            if ( have_rows( 'badges_list' ) ):?>
                                <div class="content badges-list">
                                    <?php while ( have_rows( 'badges_list' ) ) : the_row();
                                        $image = get_sub_field( 'badge' )['ID']; //ID

                                        if ( ! empty( $image ) ): ?>
                                            <?php echo wp_get_attachment_image( $image, 'featured-image', false, array('class' => 'badges-list__badge')  ); ?>
                                        <?php endif; ?>

                                    <?php endwhile; ?>
									<?php if (have_rows('badge_snippets')):
										while (have_rows('badge_snippets')): the_row();
											the_sub_field('badge_snippet', false, false);
										endwhile; 
									endif;?>
                                </div>
                            <?php endif;
