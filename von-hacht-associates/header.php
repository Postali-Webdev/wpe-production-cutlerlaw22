...
<?php
    $featured_image_url = get_the_post_thumbnail_url( get_the_ID(), 'full' ); // Or desired image size
    if ( $featured_image_url ) {
        echo '<link rel="preload" as="image" href="' . esc_url( $featured_image_url ) . '" fetchpriority="high">';
        echo '<link rel="preload" as="image" href="' . esc_url( $featured_image_url ) . '.webp" fetchpriority="high">';
    }
?>
